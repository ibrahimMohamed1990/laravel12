<header class="bg-blue-900 text-white p-4">
            <div class="container mx-auto flex justify-between items-center">
                ...
                <nav class="hidden md:flex items-center space-x-4">
                    <a href="/" class="text-white hover:underline py-2"
                        >All Jobs</a
                    >
                    <a
                        href="/saved-jobs"
                        ...
                        >Saved Jobs</a
                    >
                    <a href="/login" class="text-white hover:underline py-2"
                        >Login</a
                    >
                    <a
                        href="/register"
            ...
            >
                <a href="/jobs" class="block px-4 py-2 hover:bg-blue-700"
                    >All Jobs</a
                >
                <a
                    ...
                    >Saved Jobs</a
                >
                <a href="/login" class="block px-4 py-2 hover:bg-blue-700"
                    >Login</a
                >
                <a
                    href="/register"
